...
const char * sbsStr[] = {//Secure Boot State bits"
    ...
    "Passed"
}; // - secure boot completed with all required software authentications passing." };
...
//CMD Result Code
char * cmdResultStr[NUMCMDRESULTCODES] ={"Unspecified failure All", "Command was successful"};
char * cmdResultHexStr[NUMCMDRESULTCODES] ={"000000FF", "00000000"};
